...
class BasePageWeb extends TestBase {
	...
	private WebElement medicationModalToastMessageContainer;

	@FindBy(xpath = "//div[contains(@class,'toast-error')]/i[contains(@class,'toaster-icon')]")
	private WebElement medicationModalToastMessageIcon;

	@FindBy(xpath = "//div[contains(@class,'toast-title')]")
	private WebElement medicationModalToastMessageTitle;

	@FindBy(xpath = "//*[@class='toast-message']")
	private WebElement medicationModalToastMessage;

	public String getToastTitle() {
		log.debug("fetch the toast title");
		return medicationModalToastMessageTitle.getText();
	}

	public String getToastMessage() {
		log.debug("fetch the toast message");
		return medicationModalToastMessage.getText();
	}

	public void assertToastSuccessMsg(String toastSucTitle, String toastSucMsg) throws InterruptedException {
		log.debug("fetch the toast Title:" + getToastTitle());
		Assert.assertEquals(getToastTitle(), toastSucTitle);

		log.debug("fetch the toast Message:" + getToastMessage());
		Assert.assertEquals(getToastMessage(), toastSucMsg);

	}

	public void assertToastErrorMsg(String toastTitle, String toastErrMsg) throws InterruptedException {
		log.debug("fetch the toast Title:" + getToastTitle());
		Assert.assertEquals(getToastTitle(), toastTitle);

		log.debug("fetch the toast Message:" + getToastMessage());
		Assert.assertEquals(getToastMessage(), toastErrMsg);
